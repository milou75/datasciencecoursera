...
#Top Left : Equivalent to plot 2
plot(TWO_DAYS_HPC$DateTime, TWO_DAYS_HPC$Global_active_power, type="l", ylab="Global Active Power", xlab="")

#Top Right
plot(TWO_DAYS_HPC$DateTime, TWO_DAYS_HPC$Voltage, type="l", ylab="Voltage", xlab="datetime")
...
#Bottom Right
plot(TWO_DAYS_HPC$DateTime, TWO_DAYS_HPC$Global_reactive_power, type="l", ylab="Global_reactive_power", xlab="datetime")
